...
export const ModalTransition = forwardRef<HTMLDivElement, ModalTransitionProps>(
  ({ handleClose, handleCloseEnd, isOpen, ...rest }, ref) => {
    ...
    const [isModalMounted, modalTransitionProps] =
      useTransition<HTMLDivElement>(modalRef, isOpen);

    const layerRef = useRef<HTMLDivElement>(null);
    const [isLayerMounted, layerTransitionProps] =
      useTransition<HTMLDivElement>(layerRef, isOpen);
